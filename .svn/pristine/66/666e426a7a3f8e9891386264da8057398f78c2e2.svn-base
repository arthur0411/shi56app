...
import com.flf.mapper.ShopWithdrawalsMapper;
 ...
 * 
 * <br>
 * <b>功能：</b>ShopWithdrawalsService<br>
 */
@Service("shopWithdrawalsService")
public class ShopWithdrawalsServiceImpl extends BaseServiceImpl implements ShopWithdrawalsService {
	private final static Logger log = Logger.getLogger(ShopWithdrawalsServiceImpl.class);

	@Autowired
	private ShopWithdrawalsMapper dao;

	@Override
	public ShopWithdrawalsMapper getDao() {
		return dao;
	}

	@Override
	public List<Map<String, Object>> listAllOrder(ShopWithdrawals withdrawals) {
		return dao.listPageAllOrder(withdrawals);
	}

	@Override
	public int updateWithdrawals(ShopWithdrawals withdrawals) {
		return dao.updateWithdrawals(withdrawals);
	}

	@Override
	public XSSFWorkbook exportWithdrawals(ShopWithdrawals withdrawals) {
