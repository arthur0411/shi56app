...
public class AlipayUtil {
	 ...
	 *            退款笔数
	 * @param refundNo
	 *            商家退款流水号（3～24 位，流水号可以接受数字或英文字符，建议使用数字，但不可接受“000”）。
	 * @param refundReason
	 *            退款理由，其中不能有“^”、“|”、“$”、“#”等影响 detail_data 的格式的特殊字符
	 * @return 返回退款申请状态
	 */
	...
	public static void main(String[] args) {
		// R20160702141701238 支付成功
		// R20160630185342010 支付成功，并退款成功
		// R20160708155642045 支付失败
		// alipayTradeStatus("R20170325163004002");
		//System.out.println(refundFastpayByPlatformNopwd("2017032521001004200229679008", "0.1", 1, "time4", "测试退款"));

		// accountPageQuery("1", "2016-06-02 00:00:00", EMPTY);

		// System.out.println(notifyVerify("b901eb478abf8414aa699dc96abac24g2u"));
		singleTradeQuery("2017032521001004200229679008");
	}
