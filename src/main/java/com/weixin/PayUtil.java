...
import com.flf.util.WXRequestBean;
...
public class PayUtil {
	...
	public static void main(String[] args) {
		...
		recharge.setMoney(BigDecimal.valueOf(40000));
		recharge.setPaymentTarget("20170920110125170028");
		recharge.setRechargeFor(2);
		recharge.setRechargeType(1);
		recharge.setUserId(43);
		Map<String, Object> map = PayUtil.addWeixinOrder(recharge);
	 ...
	 * 向微信添加预支付订单
	 */
	public static Map<String, Object> addWeixinOrder(ShopRecharge recharge) {
		Map<String, Object> mapObj = new HashMap<String, Object>();

		String nonceStr = MakeOrderNum.makeRamdonNum();
		mapObj.put("nonceStr", nonceStr);
		String out_trade_no = MakeOrderNum.makeRechargeNum();

		HashMap<String, Object> map = initSignParams();
		...
		WXRequestBean wxRequestBean = getWxRequestBean(sign);
		...
		wxRequestBean.setTrade_type("APP");
		...
		try {
			...
			log.info("微信预支付返回的str：" + returnStr);
	 ...
	 * 初始化签名需要的map及公共参数
	 */
	private static HashMap<String, Object> initSignParams() {
	...
	private static WXRequestBean getWxRequestBean(String sign) {
					...
					if ("SUCCESS".equals(resultCode)) {
						...
						for (int i = 0; i < refund_count; i++) {
							...
							if ("SUCCESS".equals(refundStatus) || "PROCESSING".equals(refundStatus)) {
								...
								refundMoney = refundMoney.add((new BigDecimal(refundFee)).divide(ONE_HUNDRED, 2,
	...
	public static boolean refund(String outTradeNo, String outRefundNo, int totalFee, int refundFee) throws Exception {
		...
		wxRequestBean.setOp_user_id(Configure.getMchid());
	...
	/*public static void main(String[] args) throws Exception {
		payQuery("R20170612164659414");
		// refundQuery("R20170325162436001");
		// System.out.println(refund("R20170325162436001", "R20170325162436001",
		// 10, 10));
	}
*/
}
