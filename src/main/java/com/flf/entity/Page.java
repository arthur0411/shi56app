...
public class Page {
	...
	public String getPageStr() {
		...
		if (totalResult > 0) {
			...
			/*if(totalPage != 1) {
				sb.append("<li><input type=\"text\" style=\"width:30px\" id=\"toWhere\"/>页</li>\n");
				sb.append("<li><a href=\"#@\" onclick=\"toPage()\">跳转</a></li>\n");
			}*/
			...
			sb.append("		var topage = $(\'#toWhere\').val();\n");
			sb.append("		nextPage(topage);\n");
			sb.append("	}\n");
			sb.append("</script>\n");
		}
		pageStr = sb.toString();
