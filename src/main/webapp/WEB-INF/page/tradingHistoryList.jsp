...
<div class="mainBox">
	...
	<!-- 用于分页 -->
	<form action="/shopTradingHistory/list.html?remark3=${vo.remark3}" method="post" name="searchForm">
		<input type="hidden" name="userId" value="${vo.userId }"/>
		<input type="hidden" name="name" value="${vo.remark3}"/>
	</form>
	<div id="list">
